    ...
    <section class="section">
        <div id="carouselExampleInterval" class="carousel slide w-100 h-100 col-sm-12 col-md-8 col-lg-6 mx-auto" data-bs-ride="carousel">
           <div class="carousel-inner">
            <div id="player" class="carousel-item active" style="height: 920px;" data-bs-interval="6000">
              ...
              <div class="carousel-item" data-bs-interval="6000">
                 <img src="{{ URL::asset('storage/img/slide2.jpg') }}" class="d-block w-100" style="max-height: 800px;" alt="...">
              </div>
              <div class="carousel-item" data-bs-interval="6000">
                 <img src="{{ URL::asset('storage/img/slide3.jpg') }}" class="d-block w-100" style="max-height: 800px;" alt="...">
              </div>
              <div class="carousel-item" data-bs-interval="6000">
                 <img src="{{ URL::asset('storage/img/slide4.jpg') }}" class="d-block w-100" style="max-height: 800px;" alt="...">
              </div>
              <div class="carousel-item" data-bs-interval="6000">
                 <img src="{{ URL::asset('storage/img/slide5.jpg') }}" class="d-block w-100" style="max-height: 800px;" alt="...">
              </div>
           </div>
