...
@section('content')
    ...
    <section class="gallery min-vh-100">
      <div class="container-lg">
        <div class="row gy-4 row-cols-1 row-cols-sm-2 row-cols-md-3">
            ...
            <div class="col">
              @foreach ($files4 as $file4)
              <img src="{{ URL::asset($file4->route) }}" class="w-100 rounded object-fit-cover m-1 gallery-item" alt="gallery">
              @endforeach
            </div>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body"  style=" border-style: solid; border-width: 10px;
      border-image: linear-gradient(45deg, rgb(18, 10, 51), rgb(156, 37, 243)) 1;">
